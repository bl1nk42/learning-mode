...
This static adapter supplies the default learning guidance. Runtime switching, canonical logs, and Deep Learning are available from the Codex and Claude plugin hooks.
